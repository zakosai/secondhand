...
class UserInfoController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'buyerScore', 'sellerScore'),
				'users'=>array('@'),
			),
	...
	{
                  $id = Yii::app()->request->cookies['userID']->value;
//                  if ($this->loadModel($id) == null) $this->render('create');
//                  else 
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UserInfo']))
		{
			$model->attributes=$_POST['UserInfo'];
                        $model->id = Yii::app()->request->cookies['userID']->value;
			if($model->save())
